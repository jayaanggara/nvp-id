<?php get_header(); ?>
<div class="w-full relative bg-center bg-no-repeat bg-cover bg-[url('https://images.teamtailor-cdn.com/images/s3/teamtailor-production/hero_picture_large_full_cover-v6/image_uploads/0d9a8005-89b7-434d-8ff8-c9c339839000/original.jpeg')]">
...
<section class="pb-[100px] block-px delimiter">
    <div class="flex flex-col items-center justify-center mx-auto sm:flex-row block-max-w--md content">
            ...
            <div class="mb-8 md:mb-0 group-hover:ring-2 group-hover:ring-company-link group-hover:ring-offset-2 group-focus-visible:ring-2 group-focus-visible:ring-company-link group-focus-visible:ring-offset-2 bg-gray-300 relative h-[170px] w-[170px] rounded-full">
                <figure class="w-full h-full">
                    <picture>
                        ...
                        <img src="https://images.teamtailor-cdn.com/images/s3/teamtailor-production/square_226-v4/image_uploads/d94471aa-5732-4b4d-a5f5-34c30c10cb44/original.jpeg" alt="Picture of Aldo Winata" loading="lazy" class="w-full h-full object-cover rounded-full" width="170" height="170">
                    </picture>
                </figure>
            </div>
        </div>
        <div class="flex flex-col justify-center md:ml-8 md:relative md:top-[-6px] text-center md:text-left">
            ...
            <a class="text-lg md:text-xl text-[#41477B] font-bold" href="/people/1291673-aldo-winata">Aldo Winata</a>
...
<section class="bg-[#43497E] py-[100px]">
    <div class="delimiter mx-auto max-w-[750px]">
        ...
        <h2 class="text-[25px] md:text-[60px] text-white text-center pt-[50px] pb-[100px]">Executive Assistant</h2>
